		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img style="width: 150px" id="profile" src="${pageContext.request.contextPath }/assets/images/profile2.png">
					<h2>${pageContext.request.contextPath } 안녕하세요<br> 유정의 mysite에 방문하신 것을<br/> 환영합니다.</h2>
					<p>
					<br> HiHi 
